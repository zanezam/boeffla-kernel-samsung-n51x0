...
#
# Version: n5100 by ZaneZam (no UMS and notification led functionality, 19 CPU freq/voltages, 5 GPU freq/voltages, touch to wake support active)
#
# (C) andip71
...
KERNEL_SPECS="n5100;samsung;kk44;http://boeffla.df-kunde.de/zanezam/n5100/boeffla-kernel/"
...
# disabled for n5100 version as this is not working for this device atm.
if [ "get_ums" == "$1" ]; then
